...
import com.example.helpme.databinding.ActivityShareLocationBinding;
...
public class ShareLocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityShareLocationBinding.inflate(getLayoutInflater());
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location location) {
                try {
                    ...
                    String phoneNumber = "12333";
                    String myLatidude = String.valueOf(location.getLatitude());
                    String myLongitude = String.valueOf(location.getLatitude());
